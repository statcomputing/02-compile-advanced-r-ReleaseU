...
```r
library(lobstr)
#> Warning: 程辑包'lobstr'是用R版本3.6.3 来建造的
```
...
#> o [1:0x191c0f30] <chr> 
#> +-[2:0x12f37678] <string: "a"> 
#> +-[2:0x12f37678] 
#> +-[3:0x18fedbd8] <string: "abc"> 
#> \-[4:0x13133840] <string: "d">
```
...
#> Ncells  734805 39.3    1193568  63.8  1193568  63.8
#> Vcells 4741960 36.2   17087950 130.4 17082699 130.4
```
