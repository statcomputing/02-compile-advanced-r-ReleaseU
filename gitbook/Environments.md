...
```r
e1
#> <environment: 0x00000000180ea088>
```
...
```r
env_parent(e2b)
#> <environment: 0x00000000153b6d80>
env_parent(e2a)
...
```r
env_parents(e2b)
#> [[1]]   <env: 00000000153B6D80>
#> [[2]] $ <env: global>
env_parents(e2d)
#> [[1]]   <env: 00000000183E74C8>
#> [[2]] $ <env: empty>
```
...
env_get(e3, "xyz")
#> Error in env_get(e3, "xyz"): 缺少参数"default",也没有缺省值
```
...
plus_one
#> function(y) x + y
#> <environment: 0x000000001820f778>
```
