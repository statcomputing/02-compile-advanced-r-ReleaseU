...
A big thank you to all 5 contributors (in alphabetical order by username): Aaron Wolen (\@aaronwolen), \@absolutelyNoWarranty, Adam Hunt (\@adamphunt), \@agrabovsky, Alexander Grueneberg (\@agrueneberg).
...
This version of the book was built with R version 3.6.1 (2019-07-05) and the following packages.
