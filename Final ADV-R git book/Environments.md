...
```r
e1
#> <environment: 0x000000001798e488>
```
...
```r
env_parent(e2b)
#> <environment: 0x00000000149b4998>
env_parent(e2a)
...
```r
env_parents(e2b)
#> [[1]]   <env: 00000000149B4998>
#> [[2]] $ <env: global>
env_parents(e2d)
#> [[1]]   <env: 0000000017D81E80>
#> [[2]] $ <env: empty>
```
...
plus_one
#> function(y) x + y
#> <environment: 0x00000000156c3c58>
```
