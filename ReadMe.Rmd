...
\newpage
# Overall
Because I forgot I could catch the screen make the error messages more convince, those things was made by hand. Still has reference value on it.

For the result, we can get a good version of Html book, but a half-completed pdf book of it.

The book is compiled in the _book folder which in adv-r folder.
