...
UPDATE: The reason is just because the encoding problem. Make a encode parameter in the line 224 of *Introduction.Rmd*, like this:
...
The book is compiled in the *gitbook* folder.
